...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  `file_link` varchar(1000) NOT NULL COMMENT 'ссылка на файл',
...
CREATE TABLE IF NOT EXISTS `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `reg_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'дата регистрации пользователя',
  ...
  KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='Атрибуты пользователей';
